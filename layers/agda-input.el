...
(defcustom agda-input-translations
  ...
  ;; Shorter forms for entailment symbols (since they are frequently used in PL)

  ("vd"   . ("⊢"))
  ("vD"   . ("⊨"))
  ("Vd"   . ("⊩"))

  ;; shorter forms for some arrows common in PL theory

  ("lea"   . ("↝"))  ;; path lookup in pDOT
  ("red"   . ("↦"))  ;; reduction
